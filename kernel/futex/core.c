 ...
 */
static inline long __do_sys_get_robust_list(int pid, struct robust_list_head **head_ptr,
					    size_t *len_ptr)
{
...
long __arm64_sys_get_robust_list(const struct pt_regs *regs)
{
	long ret = __do_sys_get_robust_list((int)regs->regs[0], (struct robust_list_head **)regs->regs[1],
					    (size_t *)regs->regs[2]);
	return ret;
}
